...
function drawNotes(){
  ...
  $.each(recipes[id]['notes'], function(key, val){
    ...
    <div class="input-group mb-3">
      <button class="btn btn-outline-danger" type="button" onclick="delNote(`+key+`,'`+val+`')">🗑️</button>
...
function drawTypes(){
  $.get( "resources/index.php?type=types", function( data ) {
    ...
    $.each(list, function(key, val){
      ...
      <div class="input-group mb-3">
        <button class="btn btn-outline-danger" type="button" onclick="delType(`+key+`)">🗑️</button>
